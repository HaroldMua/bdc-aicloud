...
if __name__ == '__main__':
   ...
   mood = dl_create(username='c', namespace='aicloud', resource='gpu', image="172.17.33.146:1180/dl-framework/haroldmua/all-py36-cu111-vnc:v1")
